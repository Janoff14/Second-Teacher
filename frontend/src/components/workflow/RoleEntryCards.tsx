...
const cards = [
  {
    ...
    border: "border-brand-200/60 hover:border-brand-400 dark:border-brand-800/40 dark:hover:border-brand-600",
    icon: (
  ...
  },
  {
    ...
    border: "border-accent-200/60 hover:border-accent-400 dark:border-accent-800/40 dark:hover:border-accent-600",
    icon: (
      <svg className="h-8 w-8" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    border: "border-amber-200/60 hover:border-amber-400 dark:border-amber-800/40 dark:hover:border-amber-600",
    icon: (
      <svg className="h-8 w-8" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
